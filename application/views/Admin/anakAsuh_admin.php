            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <table id="table_id" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($anakAsuhAdmin as $value) : ?>
                                    <tr>
                                        <td><?= $i ?></td>
                                        <td><?= $value['nama'] ?></td>
                                        <td><?= $value['jk'] ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo site_url('Admin/hapusAnakAsuh/' . $value['id_anak']); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?= $value['nama']; ?> ?');" class="badge badge-danger" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash" style="font-size:20px"></i></a>
                                        </td>
                            ...
                            $('#table_id').DataTable({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        extend: 'pdfHtml5',
                                        text: 'PDF with logo',
                                        title: 'Yayasan Al-Fitroh Kedoya\nJalan Keodya Raya, Gang Asem No. 14, Rt 02, Rw 06\nLaporan Data Anak Asuh Yayasan Al-Fitroh Kedoya\nPeriode (ALL) Semua',
                ...
                <div class="modal fade modalAnakAsuh" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('Admin/tambahAnakAsuh'); ?>" method="post" enctype="multipart/form-data">
                ...
                <?php $no = 0;
                foreach ($anakAsuhAdmin as $value) : $no++; ?>
                    <div class="modal fade editAnakAsuh<?= $value['id_anak'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('Admin/editAnakAsuh'); ?>" method="post">
                                <div class="modal-content">

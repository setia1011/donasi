<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2 id="pdftitle"><?= $title; ?>  <?= $getFilter; ?></h2>
                ...
                <div class="col-sm-12">
                            ...
                            <tbody>
                                ...
                                foreach ($filterDonasi as $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('Petugas/detailDonasi/') . $value['id_donasi']; ?>" onclick="displayNone()" class="badge badge-warning"><i class="fa fa-search" style="font-size: 15px; color: white;"></i></a>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            const namapdf = document.getElementById('pdftitle').innerHTML
                            console.log(namapdf)
                            $('#table_id').DataTable({
                                ...
                                buttons: [{
                                    ...
                                    },
                                    {
                                        extend: 'pdfHtml5',
                                        text: 'PDF with logo',
                                        title: namapdf == 'Filter Donasi  Diterima' ? 'Donasi - Prototype',
